...
const { mockGetDaemonHealth, mockSendCommand, mockSetDaemonCommandTimeoutSeconds, mockFindShadowedUserAdapters, } = vi.hoisted(() => ({
...
describe('doctor report rendering', () => {
    ...
    it('reports a stale default profile when it is not among the connected profiles', async () => {
        ...
        fs.writeFileSync(path.join(configDir, 'browser-profiles.json'), JSON.stringify({ version: 1, aliases: { work: 'zvypsyje' }, defaultContextId: 'zvypsyje' }));
